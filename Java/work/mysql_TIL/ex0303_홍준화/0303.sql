...
select emp_name, job, dept_id, hiredate from emp where dept_id = 200;
...
select emp_id, emp_name, mgr_id, dept_id from emp where mgr_id in(6311,6361,6351);
...
select * from emp where job = '세일즈' or not job = '사무직';
...
select * from emp where bonus is not null and hiredate like '200%';
...
update emp set emp_name = '장동건', sal = 3500 
...
insert into users(user_seq,name,email,phone)
	values
    (111,'홍길동','hong@gildong@com','010-1111-1111'),
    (222,'이길동','lee@gildong@com','010-2222-2222'),
    (333,'삼길동','sam@gildong@com','010-3333-3333');
...
insert into users(user_seq,name,email,phone)
	values
    (222,'이길동2','lee2@gildong@com','010-2222-2222');
    
insert into users(user_seq,name,email,phone)
	values
    (2222,'이길동2','lee@gildong@com','010-2222-2222');    

insert into users(user_seq,name,phone)
	values
    (2222,'이길동2','010-2222-2222');  
    
insert into users(user_seq,name,email,phone)
	values
    (2222,'이길동2','lee2@gildong@com','010-2222-2222'); 

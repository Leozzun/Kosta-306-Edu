...
//     	     list.add(elec );
    	...
    	File file = new File("resources/objSave.txt");
    	if(file.exists()) {
            loadFile();   
        } else {
            list.add(new Electronics(100,"TV",200,"크다"));
            list.add(new Electronics(200,"냉장고",500,"대용량"));
            list.add(new Electronics(300,"세탁기",400,"드럼형"));
    ...
    private void loadFile() {
    	try(ObjectInputStream ois =
    	        new ObjectInputStream(
    	            new FileInputStream("resources/objSave.txt"))) {
    ...
    private void saveFile() {
        try(ObjectOutputStream oos =
                new ObjectOutputStream(
                    new FileOutputStream("resources/objSave.txt"))) {
